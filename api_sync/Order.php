...
function syncOrderClaimData($db, $order_id, $claimTypeMap, $claimDetailsMap) {
    ...
    switch ($method) {
        ...
        case 'POST':
            ...
            try {
                ...
                syncOrderClaimData($db, $order_id, $selected_product_claim_types, $selected_product_claim_details);
        ...
        case 'PUT':
            ...
            try {
                ...
                if (!is_null($update_product_ids) || array_key_exists('selected_product_claim_types', $input) || array_key_exists('selected_product_claim_details', $input)) {
                    $claimTargetIds = !is_null($update_product_ids)
                        ? $update_product_ids
                        : normalizeIdList($existing_order['product_ids'] ?? ($existing_order['product_id'] ?? null));
                    syncOrderClaimData($db, (int)$id, $selected_product_claim_types, $selected_product_claim_details);
