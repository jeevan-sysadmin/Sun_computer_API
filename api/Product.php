...
class Product {
    ...
    private $valid_statuses = ['active', 'discontinued'];
    ...
    public function create() {
        ...
        if ($this->checkSerialNumberExists($this->serial_number)) {
    ...
    public function update() {
        ...
        if ($this->checkSerialNumberExists($this->serial_number, $this->id)) {
